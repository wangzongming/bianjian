    ...
    const btns = flowButtons.map((item, index) => {
        ...
        switch (buttonClass) {
            case "backTop":
                ...
                //       height: "28px",
                //       background:
                //         "url(http://static.apih5.cn/icon/arrowup.svg) center center /  28px 28px no-repeat"
                //     }}
                //   />
                // );
                break;
...
class FlowSelectModal extends Component {
    ...
    // };
    render() {
        const { actionFlow: _actionFlow, myFetch, form = {} } = this.props;
...
class SegmentedPull extends Component {
    constructor(props) {
        ...
        this.values = [
            ...
            { authorId: "SecondAuthor", authorName: "协办" },
            { authorId: "Reader", authorName: "读者" }
        ];
        let selectedIndex = 0;
