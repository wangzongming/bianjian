...
class index extends PureComponent {
    ...
    static defaultProps = {
        ...
        formIsChangeedAlertTextContent: {
            title: <>温馨提示</>,
            body: <>当前内容已被编辑，您是否保存？需要保存请点击【确认】按钮后去点击右下角按钮进行保存</>,
        },
    };
    ...
    constructor(...args) {
        ...
        //设置抽屉的配置
        this.setDrawerConfig = (drawerConfig) => this.setState({ drawerConfig });

        //获取抽屉的配置
        this.getDrawerConfig = () => this.state.drawerConfig;
        ...
        this.btnCallbackFn = {
            ...
            setDrawerConfig:this.setDrawerConfig,
            getDrawerConfig:this.getDrawerConfig,  
