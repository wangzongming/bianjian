...
import { Varchar,SelectByPaging,MoneyComponent } from "./inputs"
...
export default props => {
    ...
    let {
        ...
        antdProps = {},
        form,
        form: { getFieldDecorator,getFieldValue,getFieldsValue,resetFields,setFieldsValue }, //,getFieldError
        inputProps,
        typeMessage,
        formItemLayout,
        style = {},
    ...
    //     console.log(getFieldError(field));
    //     commProps.validateStatus = "error";
    //     commProps.help = getFieldError(field).join(',');
    // }
                ...
                <FormItem {...commProps}>
                    {getFieldDecorator(field,{ ...uploadProps })(
                        ...
                        >
                            ...
                            {
                                inputProps.disabled ? null : <Button disabled={disabled}>
