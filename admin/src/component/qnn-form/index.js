...
//样式
let style = {};
class QnnForm extends PureComponent {
    static propTypes = {
        data: PropTypes.any,
    ...
    static sFormatData(data,formConfig,type,...args) {
        // if(!args.formBlocks){}
        return sFormatData(data,formConfig,type,...args);
    }
    ...
    constructor(...args) {
        ...
        this.state = {
            ...
            // 移动端 表单内容的高度
            qnnFormContextHeight: this.props.qnnFormContextHeight ? this.props.qnnFormContextHeight : window.innerHeight - 45
        };
        ...
        this.btnfns = {
            ...
            formatData: sFormatData.bind(this),
    ...
    componentDidMount() {
        ...
        window.addEventListener("resize", this.setQnnFormContextHeight, false);
    }

    componentWillUnmount() {
        this.isMounted = false;
        window.removeEventListener("resize", this.setQnnFormContextHeight, false);
    }

    setQnnFormContextHeight = () => {
        this.setState({
            qnnFormContextHeight: this.props.qnnFormContextHeight ? this.props.qnnFormContextHeight : window.innerHeight - 45
        })
    }
