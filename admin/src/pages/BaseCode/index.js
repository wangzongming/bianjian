...
import QnnTable from '../../component/qnn-table';
import QnnForm from '../../component/qnn-table/qnn-form';
import s from './style.less'
import Tree from '../../component/tree-v2'
// import Tree from '../modules/tree_backup'
...
class index extends Component {
    ...
    render() {
        ...
        return (
            <div className={s.root} style={{ height: window.innerHeight - 64 - 32 - 32 }}>
                ...
                >
                    <Tree
                                                    ...
                                                    formBtns: [
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            onClick: (res) => {
                                                                ...
                                                                if (rightClickNode.itemId === "jianSheDuiWu" || rightClickNode.itemId === "bianJianYeWu") {
                                                                    this.props.getMoreUpdateMenu()
                                                                }
                                                            }
                                                        }
                                                    ]
                                                ...
                                                formBtns: [
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        onClick: (res) => {
                                                            ...
                                                            if (res.data.codePid === "1DJP1GH9Q0086701A8C000007F2D7F96"
                                                                || res.data.codePid === "1DJP1I98Q00B6701A8C000006942DC3B") {
                                                                this.props.getMoreUpdateMenu()
                                                            }
                                                        }
                                                    }
                        ...
                        fetchConfig={{
                            ...
                            nodeDelCb: (res,props,rightClickNode) => {
                                if (this.table) {
                                    this.table.refresh();
                                }
                                if (res.data[0].codePid === "1DJP1GH9Q0086701A8C000007F2D7F96"
                                    || res.data[0].codePid === "1DJP1I98Q00B6701A8C000006942DC3B") {
                                    this.props.getMoreUpdateMenu()
                                }
                            },
                        }}
                        ...
                        onDrop={(obj) => {
                            const { afterNode,beforeNode,targetNode,parentNode,restoreTreeData } = obj;
                            let params = {
                                codeParent: parentNode,
                                codeToMove: targetNode,
                                codeAfter: afterNode,
                                codeBefore: beforeNode,
                            };
                            this.props.myFetch("moveUpdateBaseCode",params).then(({ data,success,message }) => {
                                if (success) {
                                    Msg.success(message)
                                } else {
                                    Msg.error(message);
