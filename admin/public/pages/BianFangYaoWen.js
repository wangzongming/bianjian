...
window.BianFangYaoWen = {
    ...
    formConfig: [
        ...
        },
        {
            ...
            table: {
                title: "标题", //表头标题
                dataIndex: "newsTitle", //表格里面的字段
                key: "newsTitle", //表格的唯一key 
            },
            form: {
                type: "string",
                placeholder: "请输入",
        ...
        },
        {
            ...
            table: {
                width: 120,
                title: "正文内容", //表头标题
                dataIndex: "newsContent", //表格里面的字段
                key: "newsContent" //表格的唯一key ,
            },
            form: {
                type: "richText",
                required: true,
