...
window.DuiWuJianShe = {
    fetchConfig: {
        ...
        otherParams: function (args) { 
            return {
                itemId:args.match.params.list
            }
        }
    ...
    formConfig: [
...

        {
            ...
            table: {
                title: "热点文章", //表头标题
                dataIndex: "hotFlag", //表格里面的字段
                key: "hotFlag", //表格的唯一key
